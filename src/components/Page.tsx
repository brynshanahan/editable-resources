...
import { pageCache } from "../helpers/page-cache";
...
function set(obj: {}, path: string, value: any) {
  const points = path.split(".");
  let target = obj;
  while (points.length > 1) {
    target = target[points.unshift()];
  }
  target[points[0]] = value;
}
...
const PRIVATE_FIELDS = ["type", "data", "meta"];
const DEV = true;
